	...
	<section class="notice">
		<form id="frm" action="noticeInsert.do" method="post">
			<div class="page-title">
				<div class="container">
					<h2 id="noticeInsert">Notice Insert</h2>
				</div>
			</div>
			...
			<div id="board-list">
				<div class="container">
					<table class="board-table">
						<tr>
							<th scope="col" class="th-num" id="nWriter">작성자</th>
							<td width="150" align="left"><input type="text" id="noticeWriter" name="noticeWriter" value="${name }"
								readonly="readonly"></td>
						</tr>

						<tr>
							<th scope="col" class="th-title" id="nTitle">제목</th>
							<td colspan="3"><textarea rows="1" cols="108" id="noticeTitle" name="noticeTitle" required="required"></textarea></td>
						</tr>
						<tr>
				...
				<br>
			<div align="center">
				<input type="submit" value="등록" class="btn btn-dark"> <input type="reset" value="취소" class="btn btn-dark">
