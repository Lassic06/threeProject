...
<body>
	<section class="member">
		...
		<form id="frm" action="memberTel.do" method="post" onsubmit="return changePwValidate()">
			<div id="board-list">
				<div class="container">
					<table class="board-table">
						<thead>
							<tr>
								<!-- 비밀번호 수정 -->
								<th scope="col" id="border" class="th-num">현재 전화번호</th>
								<td><div class="col-md-8">
										<input id="toTel" name="toTel" type="text"
											placeholder="${tel }" class="form-control" readonly="readonly">
									</div>
							</tr>
							<tr>
								<th scope="col" id="border" class="th-num">새 전화번호</th>
								<td><div class="col-md-8">
										<input id="memberTel" name="memberTel" type="text"
											placeholder="새 전화번호" class="form-control">
									</div></td>
							</tr>
						</tbody>
					</table>
		...
		<script type="text/javascript">
			...
			function changePwValidate() {
				...
				if (memberTel.value.trim().length == 0) {
					return printAlert(memberTel, "새 전화번호를 입력해주세요.");
					memberTel.focus();
				}
