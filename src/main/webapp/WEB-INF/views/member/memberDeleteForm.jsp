...
<body>
	<section class="member">
		...
		<form id="frm" action="memberDelete.do" method="post" onsubmit="return changePwValidate()">
			<div id="board-list">
				<div class="container">
					<table class="board-table">
						<thead>
							...
							<tr>
								<th scope="col" id="border" class="th-num">비밀번호 확인</th>
								<td><div class="col-md-8">
